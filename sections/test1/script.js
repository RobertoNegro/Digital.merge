...
function test1_show() {
  ...
  let setup = function() {
    backgroundContext = $('#test1_canvas_bg').get(0).getContext('2d');
  ...
  setup();
 	...
 	$(':radio[name="test1_question1"]').change(function() {
 		$(':radio[name="test1_question1"]').each(function(index) {
	...
	TweenMax.fromTo($('.section#test1 .test_question'), 1.5, {
   	x: '-50%',
   	opacity: 0
  }, {
    x: '0%',
	...
	$('.section#test1 .test_answers_container').css('height', '');
	$('.section#test1 .test_answers_container').css('padding', '');
  let h = $('.section#test1 .test_answers_container').outerHeight();
  let p = $('.section#test1 .test_answers_container').css('padding-top');
  TweenMax.fromTo($('.section#test1 .test_answers_container'), 1, {
   	height: '0',
   	opacity: 0,
   	padding: 0
  }, {
  ...
  TweenMax.fromTo($('.section#test1 .animation_spinner'), .5, {
    opacity: 1,
    y: '0%'
  }, {
    opacity: 0,
