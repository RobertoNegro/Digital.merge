...
function test3_hide() {
  ...
  if (test3RequestId) {
      cancelAnimationFrame(test3RequestId);
      test3RequestId = null;
  }
}

function test3_show() {
  test3HasToStop = false;
  ...
  let setup = function() {
    backgroundContext = $('#test3_canvas_bg').get(0).getContext('2d');
    ...
    test3RequestId = requestAnimationFrame(loop);
  }
  ...
  setup();
 	...
 	$(':radio[name="test3_question1"]').change(function() {
 		$(':radio[name="test3_question1"]').each(function(index) {
	...
	TweenMax.fromTo($('.section#test3 .test_question'), 1.5, {
   	x: '-50%',
   	opacity: 0
  }, {
    x: '0%',
	...
	$('.section#test3 .test_answers_container').css('height', '');
	$('.section#test3 .test_answers_container').css('padding', '');
  let h = $('.section#test3 .test_answers_container').outerHeight();
  let p = $('.section#test3 .test_answers_container').css('padding-top');
  TweenMax.fromTo($('.section#test3 .test_answers_container'), 1, {
   	height: '0',
   	opacity: 0,
   	padding: 0
  }, {
  ...
  TweenMax.fromTo($('.section#test3 .animation_spinner'), .5, {
    opacity: 1,
    y: '0%'
  }, {
    opacity: 0,
